          ...
          {previewUrl ? (
            ...
            <div className="flex flex-col items-center gap-2">
              <div className="grid h-10 w-10 place-items-center rounded-lg bg-slate-100/10">
                <Upload size={18} className="text-slate-900/90" />
              </div>
              <span className="text-xs text-slate-900/80">Dodaj zdjęcie</span>
            </div>
          )}
        </button>
          ...
          {file ? (
            <div className="flex items-start justify-between gap-3">
              <div className="min-w-0">
                <p className="truncate text-sm text-slate-900/75">{file.name}</p>
              ...
              <button
                ...
                className="inline-flex items-center gap-1 rounded-lg px-3 py-2 text-xs font-medium
                  text-slate-900 hover:bg-red-50 hover:text-red-600 transition"
              >
                <X size={14} />
                Usuń
              </button>
